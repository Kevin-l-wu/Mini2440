...
const char *cmdline = "noinitrd root=/dev/nfs rw nfsroot=192.168.1.104:/nfsroot/rootfs ip=192.168.1.99:192.168.1.104::255.255.255.0 console=ttySAC0,115200 init=/linuxrc mem=64M";
...
void setup_cmdline_tag()
{
	...
	strcpy(cur_tag_ptr->u.cmdline.cmdline, cmdline);
...
void boot_linux()
{
	...
	the_kernel = (void (*)(int, int, unsigned int))(SDRAM_KERNEL_START + 0x40);
